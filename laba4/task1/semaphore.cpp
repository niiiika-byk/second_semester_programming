...
//Semaphore – примитив синхронизации, позволяет ограничить доступ к ресурсу НЕСКОЛЬКИМ потокам одновременно.
//Семафор содержит счетчик, сколько потоков могут одновременно получить доступ к ресурсу. 
//Если счетчик >0 - можно в доступ и --счетчик. 
//Если счетчик =0 - поток мой, пока другой не освободит ресурс.
